...
# This section imports required modules and sets up logging for the Agreement Generator service.
# ==============================================================================
# -*- coding: utf-8 -*-
import sys
import os
...
VECTORSTORE_PATH = os.path.join(PROJECT_ROOT, "data", "vectorstores", "agreement_generator")
# Data uploads directory for storing uploaded documents
DATA_UPLOADS_PATH = os.path.join(PROJECT_ROOT, "data", "uploads", "agreement_generator")
...
# ==============================================================================
# SECTION 4: Agreement Generator Service
# This section defines the main function for generating agreements using OpenAI API.
# ==============================================================================

def agreement_generator_service(
    query: str,
    user_name: str = "",
    session_id: str = "",
    access_key: str = "",
    ...
    """
    Main service function for the Agreement Generator bot.
    Handles document indexing, context retrieval, and OpenAI API interaction to generate agreements or contract drafts.

    Args:
        query (str): The user's request or prompt for agreement generation.
        ...
        document_name (list): Name(s) of the uploaded document file(s).
        document_path (list): Path(s) to the uploaded document file(s).
    ...
    Returns:
        str: The generated agreement or an error message.
    """
    logging.info(f"agreement_generator_service called with query='{query}', model_name='{model_name}', temperature={temperature}, top_p={top_p}")
    ...
    system_prompt = (
        "You are a legal assistant tasked with drafting clear, professional, and structured agreements."
        "Your goal is to create a well-formatted agreement based on the provided context and user input."
        "You are an AI assistant specialized in generating agreements, contracts, or legal drafts based on user instructions and provided documents. "
        "Your responses should be clear, formal, and tailored to the user's requirements. "
        "If you don't have enough information, ask for clarification. "
        "Always use the provided context and documents to ensure accuracy and completeness."
        "If the user wants something else, clarify you can only generate agreements or contract drafts."
